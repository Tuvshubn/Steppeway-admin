...
export const uploadHeroMedia = (file) => { const fd = new FormData(); fd.append('file', file); return api.post('/api/hero/upload', fd); };
export const getAbout = () => api.get('/api/about');
export const updateAbout = (d) => api.put('/api/about', d);
export const uploadAboutImg = (file) => { const fd = new FormData(); fd.append('file', file); return api.post('/api/about/upload', fd); };
...
export const uploadTourImg = (id, file) => { const fd = new FormData(); fd.append('file', file); return api.post(`/api/tours/${id}/upload`, fd); };
